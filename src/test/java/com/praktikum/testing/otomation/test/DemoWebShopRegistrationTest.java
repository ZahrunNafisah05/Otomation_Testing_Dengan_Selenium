...
public class DemoWebShopRegistrationTest extends BaseTest {
    ...
    // Method helper lokal untuk generate email (sesuai gambar)
    // Note: Anda juga bisa menggunakan TestDataGenerator yang kita buat sebelumnya
    ...
    public void testRegistrationWithMismatchedPasswords() {
        ...
        // Kita cek apakah ada error validation ATAU URL masih di /register
