...
public class WaitStrategiesDemo {
    ...
    public void demonstrateImplicitWait() {
        ...
        // Implicit wait hanya memastikan elemen ADA di DOM, tapi tidak memastikan VISIBLE
    ...
    public void demonstrateExplicitWaitConditions() {
        ...
        // Bukan "Login" karena title aslinya "The Internet"
    ...
    public void demonstrateFluentWait() {
        ...
        WebElement finishText = fluentWait.until(d -> {
            WebElement element = d.findElement(By.id("finish"));
