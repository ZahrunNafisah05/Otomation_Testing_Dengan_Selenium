...
public class UserLoginTest extends BaseTest {
    ...
    // --- GANTI DATA INI DENGAN AKUN YANG SUDAH ANDA DAFTARKAN ---
    private String validEmail = "rayyan_testing_tetap@gmail.com";
    ...
    public void testSuccessfulLogin() {
        ...
        // Login dengan credentials valid (Menggunakan variabel di atas)
        loginPage.login(validEmail, validPassword);
        test.log(Status.INFO, "Login dengan email: " + validEmail);
    ...
    public void testLoginCaseSensitivity() {
        ...
        // Test dengan email uppercase (Gunakan variabel validEmail diubah ke uppercase)
        String upperCaseEmail = validEmail.toUpperCase();
        loginPage.login(upperCaseEmail, validPassword);
        test.log(Status.INFO, "Login dengan email uppercase: " + upperCaseEmail);
    ...
    public void testRememberMeFunctionality() {
        ...
        // Login dengan remember me (Gunakan variabel valid)
