...
public class BaseTest {
    ...
    public void setUpSuite() {
        // Inisialisasi Extent Report sebelum semua tes dimulai
    ...
    public void setUp(Method method) {
        ...
        // Create test in report (mengambil nama method tes saat ini)
    ...
    public void tearDown(ITestResult result) {
        ...
        if (result.getStatus() == ITestResult.FAILURE) {
            ...
            String screenshotPath = ScreenshotUtil.captureScreenshot(driver, result.getMethod().getMethodName() + "_FAILED");
