...
public class ProductPage extends BasePage {
    ...
    // ID ini mungkin dinamis tergantung produk (misal: add-to-cart-button-72)
    // Namun kita ikuti sesuai gambar referensi Anda:
    ...
    @FindBy(className = "content") // Biasanya elemen notifikasi bar hijau
    ...
    // Dapatkan pesan notifikasi (bar hijau di atas)
    ...
    // Klik link shopping cart (di notifikasi atau header)
    ...
    public boolean isAddedToCart() {
        try {
            ...
            // Memeriksa beberapa kemungkinan pesan sukses
